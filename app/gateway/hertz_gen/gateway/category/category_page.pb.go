...
var file_category_page_proto_goTypes = []interface{}{
	(*CategoryReq)(nil),  // 0: gateway.category.CategoryReq
	(*common.Empty)(nil), // 1: gateway.common.Empty
}
var file_category_page_proto_depIdxs = []int32{
	0, // 0: gateway.category.CategoryService.Category:input_type -> gateway.category.CategoryReq
	1, // 1: gateway.category.CategoryService.Category:output_type -> gateway.common.Empty
