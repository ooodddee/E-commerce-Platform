...
var file_order_page_proto_goTypes = []interface{}{
	(*common.Empty)(nil), // 0: gateway.common.Empty
}
var file_order_page_proto_depIdxs = []int32{
	0, // 0: gateway.order.OrderService.OrderList:input_type -> gateway.common.Empty
	0, // 1: gateway.order.OrderService.OrderList:output_type -> gateway.common.Empty
